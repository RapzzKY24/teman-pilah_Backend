...
const upload = (0, upload_middleware_1.createUpload)("news", "news");
...
router.post("/", auth_middleware_1.authenticate, upload.single("imageUrl"), newsController.create);
router.patch("/:id", auth_middleware_1.authenticate, upload.single("imageUrl"), newsController.update);
